...
export const navigationItems: NavItem[] = [
  ...
  },
  {
    ...
    subLinks: [
      ...
      { href: '/status/roadwarriorStatistics', label: 'OpenVPN: Roadwarrior Statistics', icon: ShieldCheck },       
      { href: '/status/netToNetStatistics', label: 'OpenVPN: Net-to-Net Statistics', icon: ShieldCheck },   
      { href: '/status/hardwareGraphs', label: 'Hardware Graphs', icon: BarChart3 },
      { href: '/status/connections', label: 'Connections', icon: Wifi },
      { href: '/status/netTraffic', label: 'Net-Traffic', icon: FileClock },
