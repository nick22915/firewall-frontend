...
import { GitFork, Edit, Delete } from "lucide-react";
...
export default function DnsForwarding() {
  const PageIcon = GitFork;
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  <label className=" text-gray-600 flex items-center mb-1">
                    Zone: <span className="text-redfire ml-1">*</span>
                  </label>
                  <Input
                    name="zone"
                    value={formData.zone}
                ...
                <div>
                  <label className=" text-gray-600 flex items-center mb-1">
                    Nameservers: <span className="text-redfire ml-1">*</span>
                  </label>
                  <Input
                    name="Nameservers"
              ...
              <TableBody>
                {dnsConfiguration.map((device, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell className="text-center">{device.Nameservers}</TableCell>
